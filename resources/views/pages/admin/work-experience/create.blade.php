...
@section('meta-tag')
    <meta name="description" content="Buat Pengalaman Kerja Baru">
@endsection

@section('title', "Pengalaman Kerja Baru")
@section('subtitle', "Tambahkan Pengalaman Kerja Baru")
@push('styles')
    <style>
    ...
    <section class="section">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">Tambahkan Pengalaman Kerja</h4>
            </div>
            <div class="card-body">
                <form id="create" enctype="multipart/form-data" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" id="editor" name="description"
                                  rows="20"
                                  placeholder="Deskripsi Pengalaman Kerja"></textarea>
                    </div>
