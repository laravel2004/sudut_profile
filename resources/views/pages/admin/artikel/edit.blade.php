...
@section('meta-tag')
    <meta name="description" content="Edit Artikel">
@endsection
    ...
    <section class="section">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">Perbarui Artikel</h4>
            </div>
            <div class="card-body">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                @if($data->image)
                                    ...
                                    <img src="{{ asset('storage/artikel/' . $data->image) }}" alt="{{ $data->name }}" class="img-fluid mt-2">
                                @endif
                            </div>
                        </div>
                    </div>
