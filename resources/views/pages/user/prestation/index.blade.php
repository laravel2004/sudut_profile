...
<section class="container py-5">
    <div class="card border-0 shadow-lg">
        <!-- Gambar Armada -->
        <img src="{{ asset('storage/prestation/' . $data->image) }}" class="img-fluid" alt="{{$data->slug}}">
        ...
        <div class="card-body">
            ...
            <ul class="list-group">
                <li class="list-group-item"><i class="fas fa-barcode"></i> <strong>Penyelenggara:</strong> {{ $data->competition_organizer }}</li>
            </ul>

            <!-- Deskripsi Armada -->
            <div class="group-header">Deskripsi</div>
            <div class="card-text mb-4">{!! $data->description !!}</div>
        </div>
    </div>
</section>
